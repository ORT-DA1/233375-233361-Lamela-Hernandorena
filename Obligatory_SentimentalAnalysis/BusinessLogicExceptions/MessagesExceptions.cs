...
namespace BusinessLogicExceptions
{
	public class MessagesExceptions
	{
        ...
        public static string ErrorLengthUserName = "Error. El largo del nombre de usuario \n" + "no puede ser mayor a 10 caracteres.";
        public static string ErrorLengthNameOrLastName = "Error. El largo del nombre o apellido \n" + "no puede ser mayor a 15 caracteres.";
